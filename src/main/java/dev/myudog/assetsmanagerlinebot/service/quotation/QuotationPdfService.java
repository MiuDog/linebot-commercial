 ...
 *
 * <p><b>預定呼叫鏈：</b>
 * {@code QuotationService.quote → QuotationCalculator.calculate
 * → generate → 報價檔路徑 → CommandService 回覆}。
 * 目前計算階段會先中止，本類別也尚未接到新版 Excel 模板定義。
 */
@Service
