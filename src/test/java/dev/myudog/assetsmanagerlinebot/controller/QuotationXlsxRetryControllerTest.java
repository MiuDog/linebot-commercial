...
import dev.myudog.assetsmanagerlinebot.service.quotation.QuotationGenerationJobWorker;
...
class QuotationXlsxRetryControllerTest {
	...
	private long insertFailedQuotation() {
		...
		jdbc.update("""
			...
			SELECT ?, 'user', 'U-retry-owner', 'U-retry-owner', '正定公司',
				'重試工程', '正定公司-重試工程', id, 'CONFIRMED', 1
		...
		jdbc.update("""
			...
			SELECT ?, 1, '2026081101', '正定公司-重試工程 20260811-01', '2026-08-11',
				1, '正定公司', '重試工程', '2026-08-11', '2026-08-26',
