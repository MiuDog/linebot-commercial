...
$AppImage = [System.IO.Path]::GetFullPath((Join-Path $ProjectRoot "dist\app-image\AssetsManagerLinebot"))
...
$OutputPath = [System.IO.Path]::GetFullPath((Join-Path $ProjectRoot "dist\AssetsManagerLinebot-Setup-$Version.exe"))
$NsisVersion = "3.12"
